...
public class CustomerTest {// Все тесты должны проходить, менять тесты не надо.
...
//    @Disabled //надо удалить
    ...
    void mutationTest() {
        ...
        System.out.println(customerService.getSmallest().getKey().getId());

        //when
        Map.Entry<Customer, String> smallestScore = customerService.getSmallest();
        smallestScore.getKey().setName("Vasyl");

        System.out.println(customerService.getSmallest().getKey());
